...
<head>
    ...
    <title>Pago Pendiente - Bold</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>Su pago está siendo procesado y aparece como pendiente.</p>
        ...
        <p style="color: #999; margin: 20px 0;">
            Recibirá una confirmación cuando el pago sea procesado completamente.
        </p>
    ...
    <script>
        console.log('⏳ Bold Pending Handler - Pago pendiente');
        ...
        function notifyParent() {
            if (window.opener && !window.opener.closed) {
                const message = {
                    ...
                    method: 'bold_real',
                    transaction_id: pendingData.transactionId,
                    message: 'Pago pendiente de confirmación'
                };

                try {
                    window.opener.postMessage(message, '*');
                    console.log('✅ Mensaje de pendiente enviado a ventana padre');
                } catch (error) {
