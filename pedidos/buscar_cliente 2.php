...
if (isset($_POST['buscar']) && !empty($_POST['termino'])) {
    ...
    $query = "SELECT id, nombre, telefono, correo, ciudad, direccion, fecha, monto, estado
              FROM pedidos_detal
              WHERE nombre LIKE ?
                 OR telefono LIKE ?
                 OR correo LIKE ?
...
<body>
    <div class="container-fluid">
                        ...
                        <div class="resultado-item">
                            ...
                            <div class="cliente-info">
                                ...
                                <div class="info-item">
                                    ...
                                    $<?php echo number_format($cliente['monto'], 0, ',', '.'); ?>
                                </div>
                                <div class="info-item">
        ...
        <div style="text-align: center; margin: 20px;">
            <a href="index.php" style="color: #58a6ff; text-decoration: none;">
