-- ============================================
-- MIGRACIÓN DE TABLA USUARIOS EXISTENTE
...
-- Agregar llaves foráneas (después de crear la tabla completa)
-- Nota: Se ejecutarán después de crear todas las tablas para evitar errores de dependencias

-- ============================================
-- RESTO DEL SISTEMA DE ACCESOS
-- ============================================
...
-- ============================================
-- AGREGAR LLAVES FORÁNEAS A USUARIOS
-- (Después de crear todas las tablas)
-- ============================================

-- Agregar llaves foráneas para creado_por y modificado_por
...
ADD CONSTRAINT fk_roles_modificado_por FOREIGN KEY (modificado_por) REFERENCES usuarios(id) ON DELETE SET NULL;
...
-- Crear usuario super admin inicial (usando email existente si ya hay usuarios)
