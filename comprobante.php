...
if ($orden_id) {
    ...
    $sql = "SELECT id, pedido, monto, nombre, direccion, telefono, correo, persona_recibe, horarios, metodo_pago, datos_pago, comprobante, nota_interna, fecha, estado, fecha_estado, guia, numero_guia, url_imagen_guia, comentario FROM pedidos_detal WHERE id = ?";
    ...
    $stmt->bind_result($id, $pedido, $monto, $nombre, $direccion, $telefono, $correo, $persona_recibe, $horarios, $metodo_pago, $datos_pago, $comprobante, $nota_interna, $fecha, $estado, $fecha_estado, $guia, $numero_guia, $url_imagen_guia, $comentario);
...
<body>
    <div class="comprobante">
        ...
        <div class="seccion">
            ...
            <div><?= htmlspecialchars($orden['direccion'] ?? 'N/A') ?></div>
            <div><strong>Recibe:</strong> <?= htmlspecialchars($orden['persona_recibe'] ?? 'N/A') ?></div>
            <div><strong>Horario:</strong> <?= htmlspecialchars($orden['horarios'] ?? 'N/A') ?></div>
        </div>
