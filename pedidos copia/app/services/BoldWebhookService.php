...
class BoldWebhookService
{
    ...
    public function __construct()
    {
        ...
        $this->pedidoModel = new \Pedido($connection);
    ...
    public function updateOrderStatus($pedidoId, $transactionData) {
    ...
    public function notifyAdmins($error) {
        return ['success' => true];
    }
    
    public function generateReconciliationReport($fecha) {
        return ['fecha' => $fecha, 'transacciones' => []];
    }
}
